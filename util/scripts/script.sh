...
sshpass -p 'Y@shP3n!23' ssh -T ypenugon@sr2s1.mesa.gmu.edu << EOF
  echo "Running SQL query on the database..."
  mysql -u daen690 -p'fall2024' -h sr3s14.mesa.gmu.edu -P 4439 --batch --skip-column-names -e \
...
sshpass -p 'Y@shP3n!23' scp ypenugon@sr2s1.mesa.gmu.edu:/data/home/ypenugon/indo_ns_ks.csv /Users/yashwanthp/Downloads/DAEN690_Data/indo_ns_ks.csv

# Step 3: Upload the file to S3
echo "Uploading the file to S3..."
aws s3 cp /Users/yashwanthp/Downloads/DAEN690_Data/indo_ns_ks.csv s3://insighterss3/Indonesia_outages_analysis/indo_ns_ks.csv --region us-east-1 --profile CEC_DAEN_v2-211125731410
